    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-200 p-6 rounded-lg">
          ...
          <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">category</h3>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Maggies</h2>
          ...
          <Link className="mr-8 text-white  hover:text-yellow-200 bg-blue-800 rounded p-1 my-4 cursor-pointer" href='/BrowseBrowse'>Browse </Link>
        </div>
      </div>
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-200 p-6 rounded-lg">
          ...
          <Link className="mr-8 text-white  hover:text-yellow-200 bg-blue-800 rounded p-1 my-4 cursor-pointer" href='/BrowseBrowse'>Browse </Link>
              ...
              {/* Beverages */}
<section className="text-gray-600 body-font bg-amber-100 border-4 rounded-2xl">
<h1 className='text-center  text-black sm:text-3xl text-2xl font-medium title-font mb-2 mt-4' id='Beverage'>Beverages</h1>
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
...
<section className="text-gray-600 body-font bg-blue-300 border-4 rounded-2xl ">
<h1 className='text-center  text-black sm:text-3xl text-2xl font-medium title-font mb-2 my-5' id='Pasta'>Pasta</h1>
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a className="block relative h-48 rounded overflow-hidden">
